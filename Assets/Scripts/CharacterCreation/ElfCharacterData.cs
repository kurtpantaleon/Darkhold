...
public class ElfCharacterData : CharacterData
{
    // Character Identity
    public override string characterName { get; set; } = "Thalorin Starbloom";
    public override string awaken { get; set; } = ""; // Empty
    public override string characterClass { get; set; } = "Hydromancer";
    public override string body { get; set; } = "Agile";
    public override string eyes { get; set; } = "Green";
    public override string hair { get; set; } = "Long";
    public override string race { get; set; } = "Elf";
    ...
    public override string basicSkills { get; set; } = "Tidal Wave, Frozen Touch";
    public override string specialSpells { get; set; } = "Aqua Veil";
    public override string weapon { get; set; } = "Glacier Chakrams";
    public override string wardrobe { get; set; } = "Frostshroud Coat";
